...
interface PlanSettingsOrganizationSelectorProps {
...
const PlanSettingsOrganizationSelector: React.FC<
  PlanSettingsOrganizationSelectorProps
> = ({
  ...
  const selectedOrganization = organizations.find(
    (org) => org.id === Number(selectedOrganizationId),
  );
            ...
            {organizations.map((organization) => (
              ...
              >
                <Check
                  className={cn(
                    "mr-2 h-4 w-4",
                    Number(selectedOrganizationId) === organization.id
                      ? "opacity-100"
                      : "opacity-0",
                  )}
                />
...
export default PlanSettingsOrganizationSelector;
