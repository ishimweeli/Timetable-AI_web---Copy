...
interface ClassBandScheduleCalendarCellProps {
  periodId: number;
  dayOfWeek: number;
...
const ClassBandScheduleCalendarCell: React.FC<ClassBandScheduleCalendarCellProps> = ({
  periodId,
  dayOfWeek,
  onCellClick,
  preference,
  ...
  // Use the class band-specific active preference type function
  let activePreferenceType = preference
    ? getActiveClassBandPreferenceType(preference, preferenceFields)
    : null;
...
export default ClassBandScheduleCalendarCell; 