...
interface ClassBandPreferenceToolbarProps {
...
const ClassBandPreferenceToolbar: React.FC<ClassBandPreferenceToolbarProps> = ({
  ...
  // Default class band-specific preference options if none provided
...
export default ClassBandPreferenceToolbar; 