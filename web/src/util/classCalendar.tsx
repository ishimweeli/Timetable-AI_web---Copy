...
/**
 * Count the number of active class preferences in a list of schedule preferences
 */
export const countActiveClassPreferences = (
...
/**
 * Get the active preference type from a class or teacher schedule preference
 * This is specific to class and teacher preferences
 */
export const getActiveClassPreferenceType = (
  ...
  // Class-specific preferences using the provided field names
...
/**
 * Get class preferences for the toolbar
 */
export const getClassPreferenceOptions = (): {
  type: PreferenceType;
  name: string;
  color: string;
  icon: string;
